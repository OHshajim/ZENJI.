...
export default function Cart() {
    ...
    return (
        <main className="cart-page">
            <span className="kicker">ZENJI / YOUR SELECTION</span>
            <h1>Your bag<span className="dot">.</span></h1>
            {
                items.length ?
                    <>
                        <CartSummary />
                    ...
                    <div className="empty">
                        ...
                        <p className="muted">Looks like you haven&apos;t found your next piece yet.</p>
